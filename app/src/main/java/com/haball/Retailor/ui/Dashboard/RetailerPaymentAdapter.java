...
//                        deletePayment(context, paymentsList.get(position).getRetailerInvoiceId(), paymentsList.get(position).getInvoiceNumber());
                                    ...
                                    case R.id.pay_by_make_payment:
                                        ...
                                        try {
                                            new Pay_By_Make_Payment().payByMakePaymentsRetailer(context, paymentsList.get(position).getInvoiceNumber(), Double.parseDouble(paymentsList.get(position).getTotalPrice()), new RetailerViewInvoice(), new Dashboard_Tabs(), 0);
                                        } catch (JSONException e) {
                                            e.printStackTrace();
                                        }
                                        break;
...
//                        deletePayment(context, paymentsList.get(position).getRetailerInvoiceId(), paymentsList.get(position).getInvoiceNumber());
                    ...
                    case R.id.pay_by_make_payment:
                        ...
                        try {
                            new Pay_By_Make_Payment().payByMakePaymentsRetailer(context, paymentsList.get(position).getInvoiceNumber(), Double.parseDouble(paymentsList.get(position).getTotalPrice()), new View_Payment_Fragment(), new Dashboard_Tabs(), 1);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                        break;
